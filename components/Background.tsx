          ...
          return (
            ...
            >
              <circle
                ...
                r={2}
                opacity={opacity}
                className='bg-transparent fill-zinc-300 dark:fill-stone-700'
              />
            </pattern>
          )
        })}
...
export function Background() {
  return (
    <>
      <div className='fixed inset-0 -z-[1] bg-[#f5f4f1] dark:bg-stone-900' />
      <motion.span
      ...
      <div className='mask-t pointer-events-none fixed inset-x-0 top-0 z-30 h-[88px] w-full select-none ' />
