...
const links = [
  ...
  { href: '/coding', label: 'Coding', icon: CodeIcon },
  { href: '/life', label: 'Life', icon: BsTree },
  // { href: '/services', label: 'Services', icon: TbAugmentedReality2 },
  { href: '/photography', label: 'Photography', icon: PhotographIcon },
...
export function Sidebar({ className }: { className?: string }) {
  ...
  return (
    <aside
      className={clsx('md:mx-0 md:w-44 md:flex-shrink-0 md:px-0', className)}
    >
